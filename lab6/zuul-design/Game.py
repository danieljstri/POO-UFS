...
class Game:
	...
	def __createRooms(self):
		...
		library = Room("in the university library")  
		cafeteria = Room("in the university cafeteria")  

		# initialise room exits
		outside.setExits(None, theatre, lab, pub, None, None)
		theatre.setExits(None, None, None, outside, library, cafeteria)
		...
		library.setExits(None, None, None, None, None, theatre)
		cafeteria.setExits(None, None, None, None, theatre, None)
